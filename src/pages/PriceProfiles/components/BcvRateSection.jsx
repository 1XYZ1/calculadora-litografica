    ...
    <section className={`${colors.bg} p-6 rounded-xl shadow-md`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border-2 border-teal-200">
          <p className="text-sm text-gray-600 mb-2 font-medium">Tasa Actual</p>
          <div className="flex items-baseline gap-2">
            <p className="text-4xl font-bold text-teal-600">
              {bcvRateData !== undefined ? bcvRateData.toFixed(2) : "0.00"}
            </p>
            <span className="text-lg text-gray-500">Bs./$</span>
          </div>
        </div>
        ...
        <div>
          ...
          <input
            ...
            disabled={loading}
            className="w-full p-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 disabled:opacity-50 disabled:cursor-not-allowed"
          />
