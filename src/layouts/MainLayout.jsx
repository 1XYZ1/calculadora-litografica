...
export default function MainLayout() {
  ...
  // Convertir la ruta actual a nombre de página para el Header
  const getCurrentPage = () => {
    const path = location.pathname;
    if (path.startsWith('/calculator')) return 'calculator';
    if (path.startsWith('/clients')) return 'clients';
    if (path.startsWith('/price-profiles')) return 'priceProfiles';
    if (path.startsWith('/quotations')) return 'savedQuotations';
    return 'calculator';
  };
